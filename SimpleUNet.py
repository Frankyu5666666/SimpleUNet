...
class SimpleUNet(nn.Module):
    def __init__(self, in_channels, num_cls, ks=3, dilation=1, stage_channels=5*[32], num_blocks=5*[1],  short_rate=0.5, adw=False):
...
if __name__ == '__main__':
    ...
    model = SimpleUNet(in_channels=3, num_cls=2, dilation=2, stage_channels=[24, 24, 24, 24, 24], num_blocks=[1, 2, 2, 2, 2], short_rate=0.5, adw=True).cuda()
